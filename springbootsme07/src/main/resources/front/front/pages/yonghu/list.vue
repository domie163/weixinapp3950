<template>
    ...
    <view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view v-if="index%6==0" @tap="onDetailTap(product)" class="list-item" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 20rpx 0","borderColor":"red","backgroundColor":"rgba(0, 206, 209, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
                                                                                          <image :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 8rpx 0","borderColor":"rgba(163, 169, 228, 1)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"200rpx 200rpx 20rpx 200rpx","borderWidth":"6rpx","width":"100%","borderStyle":"solid","height":"200rpx"}' mode="aspectFill" :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
                                                                                                                                  <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
            <view :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(163, 169, 228, 0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"36rpx","fontSize":"28rpx","borderStyle":"solid"}' class="title">{{product.yonghuxingming}}</view>
                                                                                                                                                                      </view>
        ...
        <view v-if="index%6==3" @tap="onDetailTap(product)" class="list-item" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 20rpx 0","borderColor":"rgba(163, 169, 228, 1)","backgroundColor":"rgba(163, 169, 228, 1)","borderRadius":"0 0 30rpx 30rpx","borderWidth":"6rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
                                                                                          <image :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"200rpx"}' mode="aspectFill" :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
                                                                                                                                  <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
            <view :style='{"padding":"10rpx 24rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(163, 169, 228, 1)","color":"#333","textAlign":"center","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","width":"100%","lineHeight":"36rpx","fontSize":"28rpx","borderStyle":"solid"}' class="title">{{product.yonghuxingming}}</view>
                                                                                                                                                                      </view>
                                                                                          <view style="display: flex;justify-content: space-between;">
            <text v-if="userid && isAuth('yonghu','修改')" class="cuIcon-edit" @click.stop="onUpdateTap(product.id)">修改</text>
            <text v-if="!userid && isAuthFront('yonghu','修改')" class="cuIcon-edit" @click.stop="onUpdateTap(product.id)">修改</text>
